    ...
    >
      <div>
        ...
        <div className="flex w-full">
          <div className="w-[9.9%] lg:w-[15%] h-10 lg:h-35 border-r border-b border-white/10 "></div>
          <div className="w-full"></div>
          <div className="w-[9.9%] lg:w-[15%] h-10 lg:h-35 border-l border-b border-white/10 "></div>
        </div>
        <div className="flex w-full">
          {/* second row */}
          <div className="w-[9.9%] lg:w-[15%]"></div>
        ...
        <div className="flex w-full">
          <div className="w-[9.9%] lg:w-[15%] h-10 lg:h-35 border-t border-r border-white/10  "></div>
          <div className="w-full"></div>
          <div className="w-[9.9%] lg:w-[15%] h-10 lg:h-35 border-t border-l border-white/10"></div>
        </div>
      </div>
    </section>
  );
