...
`}
              >
                ...
                {/* Title */}
                <h3 className="mb-4 max-w-[280px] text-[20px] font-medium leading-[1] md:mb-5 md:text-[22px] 2xl:max-w-[230px]">
                  {item.heading}
                </h3>

                {/* Description */}
                <p className="max-w-[320px] text-base leading-relaxed text-white/60 md:text-[16px] 2xl:max-w-[260px]">
                  {item.description}
                </p>
              </div>
            ))}
